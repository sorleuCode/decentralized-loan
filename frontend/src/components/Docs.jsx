            ...
            <div className="space-y-6">
              ...
              {selectedItem === "Core Features" && (
                <div className="space-y-6">
                  <ul className="list-disc pl-5 text-gray-300 text-sm sm:text-base leading-relaxed space-y-4">
                    <li>
                      <b>Collateralized Loans with CELO:</b> Borrowers can
                      request loans by depositing (CELO) as collateral. The loan
                      amount is determined based on the collateral value and a
                      predefined collateralization ratio.
                    </li>
                    <li>
              ...
              {selectedItem === "Supported Assets" && (
                <div className="space-y-6">
                  <p className="text-gray-300 text-sm sm:text-base leading-relaxed">
                    ...
                    <strong>Celo Alfajores</strong> testnet, supporting{" "}
                    <strong>cUSD and CELO </strong> as the primary assets. CELO
                    is used as collateral for loans, while cUSD is used as the
                    loan currency. Plans to introduce additional assets (e.g.,
                    other ERC-20 tokens) and expand network support (e.g., other
                    EVM-compatible chains or rollups) are in the roadmap.
                  </p>
                </div>
              )}
                ...
                <div className="space-y-6">
                  <ol className="list-decimal pl-5 text-gray-300 text-sm sm:text-base leading-relaxed space-y-4">
                    ...
                    <li>
                      ...
                      borrower, deposit CELO as collateral to secure your loan.
                      The required collateral amount is calculated based on the
                      loan amount and the platform's collateralization ratio.
                    </li>
                    <li>
                      ...
                      <ul className="list-disc pl-5 text-gray-300 text-sm sm:text-base leading-relaxed space-y-4">
                        ...
                        <li>
                          ...
                          own lending terms. Fund loans using cUSD tokens to
                          earn interest.
                        </li>
                      </ul>
                    </li>
              ...
              {selectedItem === "Creating a Borrow Order" && (
                <div className="space-y-6">
                  <ol className="list-decimal pl-5 text-gray-300 text-sm sm:text-base leading-relaxed space-y-4">
                    ...
                    <li>
                      <b>Deposit Collateral:</b> Deposit CELO as collateral to
                      secure your loan. The required collateral amount is
                      determined based on your loan amount and the platform’s
              ...
              {selectedItem === "Depositing Collateral" && (
                <div className="space-y-6">
                  ...
                  <ul className="list-disc pl-5 text-gray-300 text-sm sm:text-base leading-relaxed space-y-4">
                    <li>
                      <strong>Supported Collateral:</strong> CELO (for collateral
                      deposit).
                    </li>
                    <li>
              ...
              {selectedItem === "Loan-to-Value (LTV) Ratios" && (
                <div className="space-y-6">
                  ...
                  <ul className="list-disc pl-5 text-gray-300 text-sm sm:text-base leading-relaxed space-y-4">
                    <li>
                      For example, if you request a loan of 1,000 cUSD tokens
                      (worth $1,000), you will need to deposit at least $1,200
                      worth of collateral (CELO).
                    </li>
                    <li>
                      <strong>Maintaining a Healthy LTV:</strong>
                      <ul className="list-disc pl-5 mt-2 space-y-2">
                        <li>
                          <strong>Liquidation Threshold:</strong> If the value
                          of your collateral falls below 110% of the loan
                          amount, your loan may be liquidated to protect the
                          lender.
                        </li>
                        <li>
                          To avoid liquidation, ensure the value of your
                          collateral remains sufficient to cover the loan
                          amount.
                        </li>
                      </ul>
                    </li>
              ...
              {selectedItem === "Repayment Process" && (
                <div className="space-y-6">
                  ...
                  <ul className="list-disc pl-5 text-gray-300 text-sm sm:text-base leading-relaxed space-y-4">
                    <li>
                      <strong>Manual Repayment:</strong> You can repay the loan
                      early, including partial repayments, to reduce interest or
                      avoid liquidation risks. Repayments are made in cUSD.
                    </li>
                    <li>
                      <strong>Collateral Return:</strong> Once your loan is
                      fully repaid, including the principal and interest, your
                      collateral (CELO) will be automatically returned. The
                      collateral can then be used for future loans, or
                      withdrawn.
                    </li>
                  </ul>
                </div>
              ...
              {selectedItem === "Contact and Support" && (
                <div className="space-y-6">
                  ...
                  <ul className="list-disc pl-5 text-gray-300 text-sm sm:text-base leading-relaxed space-y-4">
                    <li>
                      <strong>Support Email:</strong> lumenvault01@gmail.com
                    </li>
                  </ul>
                </div>
              )}
