                  ...
                  <div className="flex justify-between items-start mb-4">
                    <div>
                      ...
                      <p className="text-gray-400">
                        Collateral: {Number(loan.collateralAmount).toFixed(3)} CELO
                      </p>
                    </div>
          ...
          <div className="bg-gray-800 rounded-lg max-w-md w-full p-6 border border-gray-700">
            ...
            <div className="space-y-4">
              <div className="flex justify-between items-center">
                ...
                <span className="font-medium">{selectedLoan.amount} cUSD</span>
              </div>
              <div className="flex justify-between items-center">
                <span className="text-gray-400">Collateral</span>
                <span className="font-medium">{Number(selectedLoan.collateralAmount).toFixed(3)} CELO</span>
              </div>
              <div className="flex justify-between items-center">
              ...
              <div className="bg-blue-900/20 border border-blue-800 rounded-lg p-4 flex items-start">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-300">Make sure you have enough cUSD tokens in your wallet before funding.</p>
                </div>
              </div>
